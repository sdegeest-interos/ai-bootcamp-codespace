...
Logs all user interactions using agent_logging.
"""
...
async def main():
    """Main function to run the Wikipedia agent with logging."""
    
    # Question to ask
    question = "how do capybaras form social groups?"
    ...
    print(f"  - Tools used: {', '.join(log_entry['tools'])}")
    print(f"  - Token usage: {log_entry['usage']}")
    print("=" * 80)
